...
<!-- ![logo.png]({{site.baseurl}}/assets/img/logo.png) -->
...
That was the response that I got from [Bill](https://www.linkedin.com/in/bill-kuykendall-9932a820/), my then undergrad advisor, when I mentioned my wish to study digital literacy during our first advising session. He did the right thing; I wouldn’t have gotten an honest answer from others.
...
What pushed me over the edge was a train wreck of a few months in 2021: once again, I found myself burnt out from my job, having frequent nightmares about dealing with clients who are equally burnt out themselves. I tried to convince myself that I should keep my golden handcuffs on because of the pandemic, but truth to be told, I was just paralyzed from exhaustion.

Fool me twice, shame on corporate nonsense.

(Lesson learned too late: Other than people who have selflessly cared for you, [don’t trust anyone who claims that you’re part of their “family.”](https://hbr.org/2021/10/the-toxic-effects-of-branding-your-workplace-a-family){:target="_blank" rel="noopener noreferrer"} A real family won’t throw you under the bus just to save their face.)
...
(I was immensely relieved to find out that many grad schools no longer require submission of GRE exam scores. I’d hate to waste more time and money to test myself with elaborate brain teasers. [It’s not that good of an indicator for success in PhD to begin with](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5226333/).)
...
1.  Follow the instructions exactly and literally as the admission requirements say, and don’t read too much into the details.
    
2.  Compose a persuasive and easy to follow narrative that’s free of grammatical and spelling errors, for the given topic.
    
3.  Ensure that some content is specifically tailored towards the program and faculty members of the school you’re applying for.
...
As a result, [there’s always a massive influx of CS grad school social media postings comes the application cycle](https://www.reddit.com/r/gradadmissions/search?q=cs&restrict_sr=on&include_over_18=on&sort=relevance&t=all). Anything from “please evaluate whether my profile would get me into this Ivy League school” to “how do I decide which school I should accept the offer from” to “I AM FREAKING OUT PLEASE HELP ME SHORTLIST”... It really is a bit of unique seasonal view.
...
*   Ronald Azuma’s [“So long, and thanks for the Ph.D.!”](https://www.cs.unc.edu/~azuma/hitch4)
...
*   Donald Asher’s [“Graduate Admission Essays”](https://www.donaldasher.com/books.html)
    
*   Casey Fiesler’s [video series](https://www.youtube.com/@CaseyFieslerPhD/videos), especially recommended if you’re a first-gen student
...
Join an online community early on — a small and supportive one, not a toxic waste dump like TheGradCafe — and make friends with other members. You’d be surprised how much help you can get.

I came across several peer reading programs for grad school applications (e.g., [Cornell’s Information Science admission](https://infosci.cornell.edu/phd/admissions)). They are immensely helpful based on my experience, but the slots do fill up quite quickly during the application season, so act fast if you see them.
